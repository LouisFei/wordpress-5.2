 ...
 * 钩子分为两种，一种叫做动作（action），还有一种叫做过滤器（filter）。
 * 动作的理念是让你在一种情况或者一个特别的位置执行一些函数，比如发送一封邮件等；
 * 过滤器则是让你修改 WordPress 核心需要用到的一个值，然后 WordPress 再用这些值做一些事情，比如函数的返回值等。
 *
 * @since 4.7.0
 *
 * @see Iterator
...
final class WP_Hook implements Iterator, ArrayAccess {
	 ...
	 * 规范化WordPress初始化为WP_Hook对象之前设置的过滤器。
	 *
	 * @since 4.7.0
	 *
